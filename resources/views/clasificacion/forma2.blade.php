...
<script type="text/javascript">
    ...
    $( document ).ready(function() {
        $('#btnConsulta02').click(function(){
            ...
            //alert(cadena);
            $(this).attr('href','{{ url('/') }}/forma2?'+cadena);
        });
    });
                        ...
                        <div id="home" class="tab-pane active">
                            ...
                            <div class="form-group col-lg-3">
                                ...
                                <div data-date-viewmode="years" data-date-format="yyyy-mm-dd" class="input-append date dpYears">
                                    <input name="fechaini" type="text" readonly="" size="16" class="form-control" id="fechaini" required>
                            ...
                            <div class="panel-body">
                                <div class="col-lg-8">
                                    <a href="{{ url('/') }}/forma2" type="button" class="btn btn-success" id="btnConsulta02"><i></i> Realizar Clasificación por valor Total</a> 
                                </div>
                            </div>
